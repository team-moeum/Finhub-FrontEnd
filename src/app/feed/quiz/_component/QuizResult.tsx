                    ...
                    <div className={style.container}>
                        <div className={style.bb}>
                          <p className={style.result_i}>{answerResulti}</p>
                            ...
                            <p className={style.text}>{currentQuiz.comment}</p>
                        ...
                        <div className={style.category_box}>
                            ...
                            <a href={`../${currentQuiz.topicList[0].topicName}/1`} className={style.category}>
                                #{currentQuiz.topicList[0].topicName}
                            </a>
                            <a href={`../${currentQuiz.topicList[1].topicName}/1`} className={style.category}>
                                #{currentQuiz.topicList[1].topicName}
                            </a>
                        </div>
                        </div>
