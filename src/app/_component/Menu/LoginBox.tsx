            ...
            >
              ...
              <FlexBox direction="column" ml={10} gap={6} flex={1} alignItems="flex-start">
                ...
                <Text
                  ...
                  weight={400}
                  color={
                    !userInfo.userType || userInfo.userType !== "직업 없음" ? "#50BF50" : "#CDD1D5"
                  }
                >
                  {userInfo.userType || "직업 없음"}
                </Text>
              </FlexBox>
          ...
          <FlexRow mt={20} gap={16} flexWrap="nowrap">
            ...
            <LinkButton href={"/menu/comment"} width={"100%"}>
              ...
              >
                <CommentIcon />
                <FlexBox direction="column" justifyContent="center">
                  <Text size={18} color="#50BF50">
                    내가 쓴 <Text weight={600}>댓글</Text>
                  </Text>
                </FlexBox>
              </FlexRow>
            </LinkButton>
