...
const UserTypeItem = forwardRef<HTMLLabelElement, UserTypeItemProps>(
  ({ id, name, imgPath, activeItem, itemChange }, ref) => {
    return (
      <label ref={ref} className={style.item_label}>
        ...
        <div className={style.item}>
          <div className={style.icon_box}>
            <Image src={imgPath} alt="user type avatar image" width={48} height={48} priority />
          </div>
          <p>{name}</p>
        </div>
      </label>
