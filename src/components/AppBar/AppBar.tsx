...
const BackButton = ({
  ...
  return (
    <button onClick={e => handleClick(e)}>
      {color === "white" ? <ArrowBackIcon /> : <ArrowBackBlackIcon />}
    </button>
  );
};
...
export const AppBar = ({
  ...
  return (
    <Box
      ...
      right={0}
      backgroundColor={
        fixed && backgroundColor === "transparent" ? scrolledBackgroundColor : backgroundColor
      }
      zIndex={40}
      ...
      <Box height={54}>
        <Container width="100%" height="100%" position="relative">
          <FlexRow width="100%" height="100%" alignItems="center">
            {useLeftBack ? (
              <FlexBox display="flex" alignItems="center" justifyContent="center">
            ...
            {title && (
              ...
              >
                <FlexBox height="100%">
                  <Text size={16} weight={500} color="#525252">
                    {title}
                  </Text>
                </FlexBox>
              </Box>
